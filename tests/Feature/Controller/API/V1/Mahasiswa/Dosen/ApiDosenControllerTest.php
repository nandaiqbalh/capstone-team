...
namespace Tests\Unit\Controllers\Api\V1\Mahasiswa\Dosen;
...
class ApiDosenControllerTest extends TestCase
{
    protected $token;
     ...
     * @return void
     */
    public function test_it_returns_success_response_when_fetching_dosen_data()
    {
