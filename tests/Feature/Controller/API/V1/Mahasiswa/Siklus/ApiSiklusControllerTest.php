...
namespace Tests\Feature\Api\V1\Mahasiswa\Siklus;
...
class ApiSiklusControllerTest extends TestCase
{
    protected $token;
    ...
    /** @test */
    public function test_it_returns_data_siklus_when_authenticated_user_is_active()
    {
        // Hit the endpoint with the generated token
        $response = $this->withHeaders(['Authorization' => 'Bearer ' . $this->token])
            ->json('GET', '/api/v1/mahasiswa/siklus');
    ...
    public function test_it_returns_failure_response_when_user_is_not_authenticated()
    {
        ...
        $response = $this->json('GET', '/api/v1/mahasiswa/siklus');
    ...
    public function test_it_returns_method_not_allowed_response_for_invalid_method()
    {
        ...
        $response = $this->withHeaders(['Authorization' => 'Bearer ' . $this->token])
            ->json('POST', '/api/v1/mahasiswa/siklus');
