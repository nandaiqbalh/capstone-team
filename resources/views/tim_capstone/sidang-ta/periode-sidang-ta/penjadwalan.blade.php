    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            <div class="card-body">
                                ...
                                @foreach ($rs_penguji_ta as $index => $penguji_sidangta)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ url('/admin/periode-sidang-ta/delete-dosen-penguji') }}/{{ $penguji_sidangta->user_id }}/{{ $mahasiswa->id_mahasiswa }}"
                ...
                <hr>
                <form action="{{ url('/admin/periode-sidang-ta/add-jadwal-process') }}" method="post"
                    autocomplete="off">
                    {{ csrf_field() }}
                    ...
                    <input type="hidden" name="id_periode" value="{{ $mahasiswa->id_periode }}">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ url('/admin/periode-sidang-ta/add-dosen-penguji') }}" method="get"
