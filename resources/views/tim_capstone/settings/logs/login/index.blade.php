    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-pills mb-3 " role="tablist">
                    <li class="nav-item">
                        <a href="{{ url('admin/settings/logs') }}" type="button" class="nav-link "
                    ...
                    <li class="nav-item">
                        <a href="#" type="button" class="nav-link active"
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row mb-2">
                    <div class="col-md-12">
                        <form class="form-inline" action="{{ url('/admin/settings/logs/login/search') }}" method="get"
                            autocomplete="off">
                            <div class="row">
                                ...
                                @foreach ($rs_logs as $index => $log)
                                    <tr>
                                        <td class="text-center">
                                            ...
                                            <small>
                                                <span
                                                    class="text-lowercase">{{ strtolower($dtid->nicetime($log->date)) }}</span>
                                            </small>
                                        </td>
                                        <td class="text-center">
                                            @if ($log->status == 'login')
                                                <span
                                                    class="badge bg-primary text-capitalize">{{ ucwords($log->type) . ' ' . ucwords($log->status) }}</span>
                                            @elseif($log->status == 'logout')
                                                <span
                                                    class="badge bg-danger text-capitalize">{{ ucwords($log->type) . ' ' . ucwords($log->status) }}</span>
                                            @endif
                                        </td>
