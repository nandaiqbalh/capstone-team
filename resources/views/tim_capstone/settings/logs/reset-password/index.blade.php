...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            <h5 class="card-header">Log Reset Password</h5>

            <div class="card-body">

                <div class="row mb-2">
                    <div class="col-md-12">
                        <form class="form-inline" action="{{ url('/admin/settings/logs/reset-password/search') }}"
                                ...
                                @foreach ($rs_logs as $index => $log)
                                    <tr>
                                        <td class="text-center">
                                            ...
                                            <small>
                                                <span
                                                    class="text-lowercase">{{ strtolower($dtid->nicetime($log->created_date)) }}</span>
                                            </small>
                                        </td>
