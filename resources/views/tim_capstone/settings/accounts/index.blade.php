    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row mb-2">
                    <div class="col-md-12">
                        <form class="form-inline" action="{{ url('/admin/settings/accounts/search') }}" method="get"
                            autocomplete="off">
                            <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($role_id == '01')
                                                ...
                                                @endif
                                            @endif
                                            <a href="{{ url('/admin/settings/accounts/edit_password') }}/{{ $account->user_id }}"
                                                class="btn btn-outline-secondary btn-xs m-1"> Password</a>
                                            <a href="{{ url('/admin/settings/accounts/edit') }}/{{ $account->user_id }}"
