...
<html>
    ...
    <head>
        ...
        <link href="{{ asset('vendor/libs/select2-bootstrap-5-theme-1.3.0/select2-bootstrap-5-theme.min.css') }}"
            rel="stylesheet" />
        ...
        <script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.5.2/dist/umd/popper.min.js"
            integrity="sha384-wiBToD0TGpWhA05BcRPrlA7ggzoY5KwJhUpJsjQfBRCD5vTQ6j+MFlMj90eocFJc" crossorigin="anonymous">
        </script>
        <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.6.0/js/bootstrap.min.js"
            integrity="sha384-B4gt1jrGC7Jh4AgTPSdUtOBvfO8sh+Wy6nq4Z9gFgp5IuakXm2E+AnDybp4QDg8Q" crossorigin="anonymous">
        </script>
        ...
        <script src="https://stackpath.bootstrapcdn.com/bootstrap/5.1.3/js/bootstrap.bundle.min.js"
            integrity="sha384-3wH/CwNvGyYBvYZG8BkS6+o2LgZiTVWmAVDhMzD2CtmzAWb1kFw5gYhJv6Q8/Kl/" crossorigin="anonymous">
        </script>
        ...
        <link hpref="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote-bs4.min.css" rel="stylesheet">
...
<div class="modal fade text-left modal-borderless" id="yt-preview" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel2" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <div class="row justify-content-center">
                    <div class="col-md-12 text-center">
                        <iframe class="card-video " src="" id="yt-iframe" title="YouTube video player"
                            frameborder="0"
...
<!-- modal preview pdf -->
<div class="modal fade text-left modal-borderless" id="modal-preview-pdf" tabindex="-1" role="dialog"
    aria-labelledby="myModalLabel3" style="display: none;" aria-hidden="true">
