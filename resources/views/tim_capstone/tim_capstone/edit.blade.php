...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ url('/tim-capstone/mahasiswa/edit-process') }}" method="post" autocomplete="off">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" step='any' class="form-control" name="ipk"
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="sks" value="{{ $mahasiswa->sks }}"
                                    required>
                            </div>
                        </div>
                    </div>
