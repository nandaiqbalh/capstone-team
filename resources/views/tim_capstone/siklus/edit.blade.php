                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" name="pendaftaran_mulai" value="{{ $siklus->pendaftaran_mulai }}" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        <label >Pendaftaran Selesai<span class="text-danger">*</span></label>
                                        <input type="date" class="form-control" name="pendaftaran_selesai" value="{{ $siklus->pendaftaran_selesai }}" required>
                                    </div>
                                </div>
                            </div>
                        </div>
