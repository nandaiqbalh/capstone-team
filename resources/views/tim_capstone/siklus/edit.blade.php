...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h5 class="fw-bold py-3 mb-6"><span class="text-muted fw-light">Admin /</span> Siklus</h5>
        <!-- notification -->
        ...
        <div class="card">
            ...
            <form id="updateForm" action="{{ url('/tim-capstone/siklus/edit-process') }}" method="post" autocomplete="off">
                <div class="card-body">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input style="background-color: transparent;" id="pendaftaran_mulai" type="text"
                                    class="form-control" name="pendaftaran_mulai" value="{{ $siklus->pendaftaran_mulai }}"
                                    required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input style="background-color: transparent;" id="pendaftaran_selesai" type="text"
                                    class="form-control" name="pendaftaran_selesai"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input style="background-color: transparent;" id="batas_submit_c100" type="text"
                                    class="form-control" name="batas_submit_c100" value="{{ $siklus->batas_submit_c100 }}"
                                    required>
                            </div>
                        </div>
                    </div>
