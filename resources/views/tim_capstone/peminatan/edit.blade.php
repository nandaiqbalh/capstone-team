...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            <form action="{{ url('/admin/peminatan/edit-process') }}" method="post" autocomplete="off">
                <div class="card-body">
                    {{ csrf_field()}}
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nama_peminatan" value="{{ $peminatan->nama_peminatan }}" required>
                            </div>
                        </div>
                    </div>
                </div>
