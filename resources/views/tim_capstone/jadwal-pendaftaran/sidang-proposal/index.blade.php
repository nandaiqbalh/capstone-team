        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row justify-content-end mb-2">
                    <div class="col-auto ">
                        <a href="{{ url('/admin/jadwal-pendaftaran/sidang-proposal/add') }}"
                                ...
                                @foreach ($rs_sidang as $index => $pendaftaran)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{ url('/admin/jadwal-pendaftaran/sidang-proposal/edit') }}/{{ $pendaftaran->id }}"
                                                class="btn btn-outline-warning btn-xs m-1 "> Ubah</a>
                                            <a href="{{ url('/admin/jadwal-pendaftaran/sidang-proposal/delete-process') }}/{{ $pendaftaran->id }}"
