...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        ...
        <div class="card-body">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="nomor_kelompok" value="{{ old('nomor_kelompok',$kelompok->nomor_kelompok) }}" placeholder="Masukan Nomor Kelompok" required>
                                    </div>
                                </div>
                            </td>
                        </tr>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <select class="form-select" name="topik" required>
                                            ...
                                            <option value="{{ $topik->id }}" @if( $topik->nama == $kelompok->nama_topik ) selected @endif>{{$topik->nama}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <select class="form-select" name="status_kelompok" required>
                                            <option value="menunggu persetujuan" disabled selected>Menunggu Persetujuan</option>
                                            <option value="disetujui" @if( old('status_kelompok',$kelompok->status_kelompok) == 'disetujui' ) selected @endif>Disetujui</option>
                                            <option value="tidak disetujui" @if( old('status_kelompok',$kelompok->status_kelompok) == 'tidak disetujui' ) selected @endif>Tidak Disetujui</option>
                                        </select>
                                    </div>
                                </div>
                            </td>
            ...
            {{-- dosen penguji  --}}
            <br>
                @if (count($rs_dospenguji) >= 2)

                @else
                <button type="button" class="btn btn-primary btn-xs float-end" data-bs-toggle="modal" data-bs-target="#DosenPenguji">
                ...
                <div class="table-responsive text-nowrap">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            @if($rs_dospenguji->count() > 0)
                            @foreach($rs_dospenguji as $index => $dosbing)
                            <tr>
                                <td class="text-center">{{ $index + 1 }}.</td>
                                <td>{{ $dosbing->user_name }}</td>
                                <td>{{ $dosbing->nomor_induk }}</td>
