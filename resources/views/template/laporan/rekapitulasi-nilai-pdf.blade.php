...
<head>
  ...
  <title>EXECUTIVE REPORT NILAI SELURUH RUMAH SAKIT @if($region_name != '0') {{strtoupper($region_name)}} @endif</title>
  <style>
  ...
  <div class="page">
      <div class="content">
            <div class="block-2">
                <div class="title">
                    <h3>
                        EXECUTIVE REPORT NILAI SELURUH RUMAH SAKIT @if($region_name != '0') {{strtoupper($region_name)}} @endif										
                        <br>
                    ...
                    <table >
                        <thead style="text-align: center;">
                            <tr style="vertical-align: middle;">
                                ...
                                <td colspan="2">Pembersihan (A)</td>
                                <td colspan="2">Perbaikan (B)</td>
                                <td colspan="2">Penggantian (C)</td>
                                <td colspan="2">Belum Dinilai (D)</td>
                            </tr>
                            <tr>
                                <td>Jumlah<br> Pembersihan</td>
                                <td>%<br> Pembersihan</td>
                                <td>Jumlah<br> Perbaikan</td>
                                <td>%<br> Perbaikan</td>
                                <td>Jumlah<br> Penggantian</td>
                                <td>%<br> Penggantian</td>
                                <td>Jumlah<br> Belum Dinilai</td>
                                <td>%<br> Belum Dinilai</td>
                            </tr>
                        </thead>
                        <tbody>
                            @if($rs_laporan_ronde->count() > 0)
                                ...
                                <tr >
                                    ...
                                    <td style="text-align: center;">{{number_format($laporan_ronde->total_komponen,0,",",".")}}</td>
                                    <td style="text-align: center;">{{number_format($laporan_ronde->total_pembersihan,0,",",".")}}</td>
                                    <td style="text-align: center;">{{round($laporan_ronde->persen_pembersihan,2)}}%</td>
                                    <td style="text-align: center;">{{number_format($laporan_ronde->total_perbaikan,0,",",".")}}</td>
                                    <td style="text-align: center;">{{round($laporan_ronde->persen_perbaikan,2)}}%</td>
                                    <td style="text-align: center;">{{number_format($laporan_ronde->total_penggantian,0,",",".")}}</td>
                                    <td style="text-align: center;">{{round($laporan_ronde->persen_penggantian,2)}}%</td>
                                    <td style="text-align: center;">{{number_format($laporan_ronde->total_belum_dinilai,0,",",".")}}</td>
                                    <td style="text-align: center;">{{round($laporan_ronde->persen_belum_dinilai,2)}}%</td>
                                </tr>
                                @endforeach
                                    ...
                                    <table style="text-align: center;">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;">{{number_format($summary->total_pembersihan,0,",",".")}}</td>
                                                <td style="text-align: center;">{{round($summary->persen_pembersihan,2)}}%</td>
                                                ...
                                                <td style="text-align: center;">{{number_format($summary->total_belum_dinilai,0,",",".")}}</td>
                                                <td style="text-align: center;">{{round($summary->persen_belum_dinilai,2)}}%</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
