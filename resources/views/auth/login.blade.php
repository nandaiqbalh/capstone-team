...
<html>
    ...
    <head>
        ...
        <meta name="generator" content="Teknik Komputer Universitas Diponegoro">
        ...
        <style>
            .btn-primary:hover {
                ...
                /* Warna latar belakang sesuai dengan warna primary */
                border-color: blue !important;
                /* Warna border sesuai dengan warna primary */
            }
                            ...
                            <div class="card-body" style="margin-left:10px;margin-right:10px;">
                                ...
                                <div class="app-brand d-flex justify-content-center align-items-center"
                                    ...
                                    <a href="{{ url('/') }}" class="app-brand-link gap-2">
                                        <img style="height: 150px" src="{{ asset('img/logo.png') }}" alt="logo"
                                            class="img-fluid">
                                    </a>
                                </div>
                                <!-- Text -->
                                ...
                                <form id="formAuthentication" action="{{ url('/login/process') }}" method="POST">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control" name="id_pengguna"
                                            value="{{ old('id_pengguna') }}" minlength="6" maxlength="25"
                                    ...
                                    <div class="mb-2 form-password-toggle">
                                        ...
                                        <div class="input-group input-group-merge">
                                            <input type="password" name="password" class="form-control" minlength="8"
                                                maxlength="20" placeholder="Masukkan kata sandi" required />
