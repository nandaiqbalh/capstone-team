...
<div class="card">
    ...
    <div class="card-footer">
      <a href="{{url('admin/validator/laporan/rata-rata-nilai')}}" class="btn btn-secondary btn-sm float-end">Lihat Selengkapnya</a>
    </div>
</div>
<br>
...
<div class="card">
    ...
    <div class="card-footer">
      <a href="{{url('admin/validator/laporan/parameter-rumah-sakit')}}" class="btn btn-secondary btn-sm float-end">Lihat Selengkapnya</a>
    </div>
</div>
<br>
...
<div class="card">
  <h5 class="card-header"> 
    Rekapitulasi Terlambat Persetujuan Seluruh Rumah Sakit Tahun {{date('Y')}}
  </h5>
  ...
  <div class="card-footer">
    <a href="{{url('admin/validator/laporan/terlambat-submit')}}" class="btn btn-secondary btn-sm float-end">Lihat Selengkapnya</a>
  </div>
</div>
<br>
...
<div class="card">
    ...
    <div class="card-footer">
      <a href="{{url('admin/validator/laporan/hasil-pekerjaan-rumah-sakit')}}" class="btn btn-secondary btn-sm float-end">Lihat Selengkapnya</a>
    </div>
</div>
<br>
...
<div class="card">
  ...
  <div class="card-footer">
    <a href="{{url('admin/validator/laporan/pekerjaan-terlambat-persetujuan')}}" class="btn btn-secondary btn-sm float-end">Lihat Selengkapnya</a>
  </div>
</div>
<br>
...
<script defer>
  // get data
  var url = "{{ url('/admin/dashboard/validator') }}";
  var data = [];
