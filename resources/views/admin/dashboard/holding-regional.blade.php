...
<div class="card">
    <h5 class="card-header"> 
      Rekapitulasi Nilai Seluruh Rumah Sakit Regional {{Auth::user()->region_id}} Tahun {{date('Y')}} 
    </h5>
    ...
    <div class="card-footer">
      <a href="{{url('admin/holding-regional/laporan/rekapitulasi-nilai')}}" class="btn btn-secondary btn-sm float-end">Lihat Selengkapnya</a>
    </div>
</div>
<br>
...
<div class="card">
    <!-- NILAI TERTINGGI -->
    <h5 class="card-header"> Rekapitulasi Nilai Tertinggi 3 Rumah Sakit Regional {{Auth::user()->region_id}} Tahun {{date('Y')}}</h5>
    ...
    <br>
    <!-- NILAI TERTINGGI -->
    <h5 class="card-header"> Rekapitulasi Nilai Terendah 3 Rumah Sakit Regional {{Auth::user()->region_id}} Tahun {{date('Y')}}</h5>
...
<!-- RATA RATA NILAI RS -->
<div class="card">
    <h5 class="card-header">Rekapitulasi Rata-Rata Nilai Seluruh Rumah Sakit Regional {{Auth::user()->region_id}} Tahun {{date('Y')}}</h5>
    ...
    <div class="card-footer">
      <a href="{{url('admin/holding-regional/laporan/rata-rata-nilai')}}" class="btn btn-secondary btn-sm float-end">Lihat Selengkapnya</a>
    </div>
</div>
<br>
...
<div class="card">
    <h5 class="card-header"> Rekapitulasi Parameter Seluruh Rumah Sakit Regional {{Auth::user()->region_id}} Tahun {{date('Y')}}</h5>
    ...
    <div class="card-footer">
      <a href="{{url('admin/holding-regional/laporan/parameter-rumah-sakit')}}" class="btn btn-secondary btn-sm float-end">Lihat Selengkapnya</a>
    </div>
</div>
<br>
...
<div class="card">
  <h5 class="card-header"> 
    Rekapitulasi Terlambat Submit Seluruh Rumah Sakit Regional {{Auth::user()->region_id}} Tahun {{date('Y')}}
  </h5>
  ...
  <div class="card-footer">
    <a href="{{url('admin/holding-regional/laporan/terlambat-submit')}}" class="btn btn-secondary btn-sm float-end">Lihat Selengkapnya</a>
  </div>
</div>
<br>
...
<div class="card">
    <h5 class="card-header"> 
      Rekapitulasi Hasil Pekerjaan Seluruh Rumah Sakit Regional {{Auth::user()->region_id}} Tahun {{date('Y')}}
    </h5>
    ...
    <div class="card-footer">
      <a href="{{url('admin/holding-regional/laporan/hasil-pekerjaan-rumah-sakit')}}" class="btn btn-secondary btn-sm float-end">Lihat Selengkapnya</a>
    </div>
</div>
<br>
...
<div class="card">
  <h5 class="card-header"> 
    Rekapitulasi Pekerjaan Terlambat Persetujuan Seluruh Rumah Sakit Regional {{Auth::user()->region_id}} Tahun {{date('Y')}}
  </h5>
  ...
  <div class="card-footer">
    <a href="{{url('admin/holding-regional/laporan/pekerjaan-terlambat-persetujuan')}}" class="btn btn-secondary btn-sm float-end">Lihat Selengkapnya</a>
  </div>
</div>
<br>
...
<script defer>
  // get data
  var url = "{{ url('/admin/dashboard/holding-regional') }}";
  var data = [];
...
<script>
  ...
  // function rekapitulasiNilai(data){
...
<script>
  //  get data
  $.ajax({
      url: "{{ url('/admin/dashboard/holding-regional-ajax-data-pekerjaan') }}",
      cache: false,
      method: "GET",
      success: function(response) {
        // remove spinner
...
<script>
  //  get data
  $.ajax({
      url: "{{ url('/admin/dashboard/holding-regional-ajax-data-pekerjaan-terlambat-persetujuan') }}",
      cache: false,
      method: "GET",
      success: function(response) {
