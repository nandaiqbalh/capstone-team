...
@section('content')
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <!-- Bordered Table -->
                <div class="card">
                    <h5 class="card-header">Daftar Akun Bamasama</h5>

                    <div class="card-body">    
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <form class="form-inline" action="{{ url('/admin/pj/register/akun/search') }}" method="get" autocomplete="off">
                                    <div class="row">
                        ...
                        <div class="row justify-content-end mb-2">
                            <div class="col-auto ">
                                <a href="{{ url('/admin/pj/register/akun/add') }}" class="btn btn-primary btn-xs float-right"><i class="bx bx-plus"></i> Tambah</a>
                            </div>
                        </div>
                                        ...
                                        @if($rs_branch_account->count() > 0)
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ url('/admin/pj/register/akun/edit') }}/{{ $branch_account->user_id }}" class="btn btn-outline-warning btn-xs m-1 "> Ubah</a>
                                                    <a href="{{ url('/admin/pj/register/akun/delete-process') }}/{{ $branch_account->user_id }}" class="btn btn-outline-danger btn-xs m-1 " onclick="return confirm('Apakah anda ingin menghapus {{ $branch_account->user_name }} ?')"> Hapus</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        @else
