            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Pendaftaran Akun Bamasama</h5>
                    ...
                    <form action="{{ url('/admin/pj/register/akun/add-process') }}" method="post" autocomplete="off">
                        <div class="card-body">
                            {{ csrf_field()}}
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="nik" value="{{ old('nik') }}" minlength="6" maxlength="11" pattern="[0-9]+" required>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" name="role_id" readonly>
                                            <option value="02" @if( old('role_id') == '02' ) selected @endif>Admin</option>
                                        </select>
                                    </div>
                                </div>
