            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    ...
                    <div class="card-body">    
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <form class="form-inline" action="{{ url('/admin/settings/rest-api/search') }}" method="get" autocomplete="off">
                                    <div class="row">
                                        <div class="col-auto mt-1">
                                            <input class="form-control mr-sm-2" type="search" name="user_name" value="{{ !empty($user_name) ? $user_name : '' }}" placeholder="Nama" minlength="1" required>
                                        </div>
                                        <div class="col-auto mt-1">
                                ...
                                <tbody>
                                    @if($rs_user_api_active->count() > 0)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                              <a href="{{ url('/admin/settings/rest-api/delete_process') }}/{{ $user_api_active->user_id }}" class="btn btn-outline-danger btn-xs m-1" onclick="return confirm('Yakin ingin menghapus koneksi API untuk user {{ $user_api_active->user_name }} ?')"><i class="fas fa-trash-alt"></i> Hapus</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    @else
                        ...
                        <div class="row mt-3 justify-content-between">
                            <div class="col-auto ">
                                <p>Menampilkan {{ $rs_user_api_active->count() }} dari total {{ $rs_user_api_active->total() }} data.</p>
                            </div>
                            <div class="col-auto ">
