            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <form class="form-inline" action="{{ url('/admin/settings/logs/reset-password/search') }}" method="get" autocomplete="off">
                                    <div class="row">
                                        ...
                                        @if($rs_logs->count() > 0)
                                            ...
                                            <tr>
                                                <td class="text-center">
                                                    ...
                                                    <br>
                                                    <small>
                                                    <span class="text-lowercase">{{ strtolower($dtid->nicetime($log->created_date)) }}</span>
                                                    </small>
                                                </td>
