            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Ubah Akun Rumah Sakit</h5>
                    ...
                    <form action="{{ url('/admin/checker/register/akun-rs/edit-process') }}" method="post" autocomplete="off">
                        <div class="card-body">
                            {{ csrf_field()}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="nik" value="{{ old('nik', $branch_account->nik) }}" minlength="16" maxlength="16" placeholder="NIK" pattern="[0-9]+" required>
                                    </div>
                                </div>
