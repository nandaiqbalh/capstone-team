...
@section('content')
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    ...
                    <div class="card-body">    
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <form class="form-inline" action="{{ url('/admin/verifikator/laporan/ronde/search') }}" method="get" autocomplete="off">
                                    <div class="row">
                                    ...
                                    @if($rs_laporan_ronde->count() > 0)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{url('/admin/verifikator/laporan/ronde/unduh-laporan')}}/{{ $laporan_ronde->id }}" class="btn btn-outline-secondary btn-xs m-1">Unduh Laporan</a>
            ...
            <script type="text/javascript">
                ...
                function unduhLampiran(id) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{url('/admin/verifikator/laporan/ronde/ajax-unduh-lampiran')}}",
                        data : {
                            _token : '{{csrf_token()}}',
                            id : id,
