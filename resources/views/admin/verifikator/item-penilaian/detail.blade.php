            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Detail Fasilitas</h5>
                        <small class="text-muted float-end">
                            <a href="{{ url('/admin/verifikator/item-penilaian') }}" class="btn btn-secondary btn-xs float-right"><i class="bx bx-chevron-left"></i> Kembali</a>
                        </small>
                    </div>
                    <div class="card-body">
                         <!-- table info -->
                        <div class="table-responsive">
                            <table class="table table-borderless table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td width="15%">ID Item Penilaian</td>
                                        <td width="5%">:</td>
                                        <td>{{ $item->id }}</td>
                                    </tr>
                                    <tr>
