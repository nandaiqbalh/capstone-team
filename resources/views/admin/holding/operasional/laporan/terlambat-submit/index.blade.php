...
@section('title')
    Rekapitulasi Penilaian Terlambat Submit
@endsection

@section('content')
    
            <div class="container-xxl flex-grow-1 container-p-y">
                <h5 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Laporan /</span> Rekapitulasi Penilaian Terlambat Submit</h5>
                <!-- notification -->
                @include("template.notification")

                <!-- Bordered Table -->
                <div class="card">
                    <h5 class="card-header">Rekapitulasi Penilaian Terlambat Submit</h5>

                    <div class="card-body">    
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <form class="form-inline" action="{{ url('/admin/holding-operasional/laporan/terlambat-submit/search') }}" method="get" autocomplete="off">
                                    <div class="row">
                                    ...
                                    @if($rs_terlambat_submit->count() > 0)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{ url('/admin/holding-operasional/laporan/terlambat-submit/detail') }}/{{$terlambat_submit->id}}/{{$key}}/{{$year}}">
