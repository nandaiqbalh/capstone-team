                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <small class="text-muted float-end">
                            <a href="{{ url('/admin/holding-regional/laporan/pekerjaan') }}" class="btn btn-secondary btn-xs "><i class="bx bx-chevron-left"></i> Kembali</a>
                        </small>
                    </div>
                    <div class="card-body">
                        <br>
                        <div style="max-height: 900px; overflow-y:scroll;">
                            @include('/admin/holding/regional/laporan/pekerjaan/executive-report-pdf')
                        </div>
