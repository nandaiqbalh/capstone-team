...
@section('title')
    Rekapitulasi Parameter Seluruh Rumah Sakit Regional {{Auth::user()->region_id}}
@endsection

@section('content')
    
            <div class="container-xxl flex-grow-1 container-p-y">
                <h5 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Laporan /</span> Rekapitulasi Parameter Seluruh Rumah Sakit Regional {{Auth::user()->region_id}}</h5>
                <!-- notification -->
                @include("template.notification")

                <!-- Bordered Table -->
                <div class="card">
                    <h5 class="card-header">Rekapitulasi Parameter Seluruh Rumah Sakit Regional {{Auth::user()->region_id}}</h5>

                    <div class="card-body">    
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <form class="form-inline" action="{{ url('/admin/holding-regional/laporan/parameter-rumah-sakit/search') }}" method="get" autocomplete="off">
                                    <div class="row">
