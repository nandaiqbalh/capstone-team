            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    ...
                    <div class="card-body">    
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <form class="form-inline" action="{{ url('/admin/validator/master/area/search') }}" method="get" autocomplete="off">
                                    <div class="row">
                        ...
                        <div class="row justify-content-end mb-2">
                            <div class="col-auto float-end">
                                @if($role_id != '06')
                                <a href="{{ url('/admin/validator/master/area/add') }}" class="btn btn-primary btn-xs"><i class="bx bx-plus"></i> Tambah</a>
                                    ...
                                    @if($rs_area->count() > 0)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{ url('/admin/validator/master/area/detail') }}/{{ $area->id }}" class="btn btn-outline-secondary btn-xs m-1 ">Detail</a>
                                                @if($role_id != '06')
                                                <a href="{{ url('/admin/validator/master/area/edit') }}/{{ $area->id }}" class="btn btn-outline-warning btn-xs float-right">Ubah</a>
                                                <a href="{{ url('/admin/validator/master/area/delete_process') }}/{{ $area->id }}" class="btn btn-outline-danger btn-xs m-1 " onclick="return confirm('Apakah anda ingin menghapus?')">Hapus</a>
                                                @endif
                                            </td>
                                        </tr>
                                        @endforeach
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="uploadExcelModalLabel">Impor Data Area</h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="{{ url('/admin/validator/master/area/import_data') }}" class="dropzone" id="my-dropzone" method="post" autocomplete="off" enctype="multipart/form-data">
                                            {{ csrf_field()}}
                                        </form>
