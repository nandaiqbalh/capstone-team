            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    ...
                    <div class="card-body">    
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <form class="form-inline" action="{{ url('/admin/validator/master/lokasi/search') }}" method="get" autocomplete="off">
                                    <div class="row">
                        ...
                        <div class="row justify-content-end mb-2">
                            <div class="col-auto float-end">
                                @if($role_id != '06')
                                <a href="{{ url('/admin/validator/master/lokasi/add') }}" class="btn btn-primary btn-xs"><i class="bx bx-plus"></i> Tambah</a>
                        ...
                        <div class="table-responsive text-nowrap">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    @if($rs_location->count() > 0)
                                        @foreach($rs_location as $index => $location)
                                        <tr>
                                            <td class="text-center">{{ $index + $rs_location->firstItem() }}</td>
                                            <td>{{ $location->name }}</td>
                                            <td>{{ $location->description }}</td>
                                            <td class="text-center">
                                                <a href="{{ url('/admin/validator/master/lokasi/detail') }}/{{ $location->id }}" class="btn btn-outline-secondary btn-xs m-1 ">Detail</a>
                                                @if($role_id != '06')
                                                <a href="{{ url('/admin/validator/master/lokasi/edit') }}/{{ $location->id }}" class="btn btn-outline-warning btn-xs float-right">Ubah</a>
                                                <a href="{{ url('/admin/validator/master/lokasi/delete_process') }}/{{ $location->id }}" class="btn btn-outline-danger btn-xs m-1 " onclick="return confirm('Apakah anda ingin menghapus?')">Hapus</a>
                        ...
                        <div class="row mt-3 justify-content-between">
                            <div class="col-auto ">
                                <p>Menampilkan {{ $rs_location->count() }} dari total {{ $rs_location->total() }} data.</p>
                            </div>
                            <div class="col-auto ">
                                {{ $rs_location->links() }}
                            </div>
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="uploadExcelModalLabel">Impor Data Lokasi</h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="{{ url('/admin/validator/master/lokasi/import_data') }}" class="dropzone" id="my-dropzone" method="post" autocomplete="off" enctype="multipart/form-data">
                                            {{ csrf_field()}}
                                        </form>
