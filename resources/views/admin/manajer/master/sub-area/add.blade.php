            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Pendaftaran Sub Area</h5>
                    ...
                    <div class="card-body">
                        <form action="{{ url('/admin/validator/master/sub-area/add_process') }}" method="post" autocomplete="off">
                            {{ csrf_field()}}
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select select-2" name="area_id" required>
                                            ...
                                            <option value="{{$area->id}}" @if( old('area_id') == $area->id ) selected @endif>{{$area->name}} (Lokasi {{$area->location_name}})</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
