            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="nav-align-top mb-2">
                    <ul class="nav nav-pills mb-3" role="tablist">
                      <li class="nav-item">
                        <a
                            href="{{url('/admin/validator/laporan/hasil-pekerjaan-rumah-sakit')}}"
                          type="button"
                          class="nav-link"
                        >
                          Perbaikan
                ...
                <div class="card">
                    ...
                    <div class="card-body">    
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <form class="form-inline" action="{{ url('/admin/validator/laporan/hasil-pekerjaan-rumah-sakit/penggantian/search') }}" method="get" autocomplete="off">
                                    <div class="row">
