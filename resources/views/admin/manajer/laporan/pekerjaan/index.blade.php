...
@section('content')
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    ...
                    <div class="card-body">    
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <form class="form-inline" action="{{ url('/admin/validator/laporan/pekerjaan/search') }}" method="get" autocomplete="off">
                                    <div class="row">
                                        <div class="col-md-9">
                                            <div class="row">
                                    ...
                                    @if($rs_laporan_pekerjaan->count() > 0)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{url('/admin/validator/laporan/pekerjaan/unduh-laporan')}}/{{ $laporan_pekerjaan->id }}" class="btn btn-outline-secondary btn-xs m-1">Unduh Laporan</a>
            ...
            <div class="modal fade" id="erRangkumanBCDModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="erRangkumanBCDModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-sm">
                    <div class="modal-content">
                        ...
                        <form action="{{url('/admin/validator/laporan/pekerjaan/unduh-laporan-rekapitulasi-nilai')}}" method="post" id="form-rangkuman-abcd">
                        {{ csrf_field()}}
                            <div class="modal-body">
                                <div class="mb-3">
            ...
            <script type="text/javascript">
                ...
                function unduhLampiran(id) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{url('/admin/validator/laporan/pekerjaan/ajax-unduh-lampiran')}}",
                        data : {
                            _token : '{{csrf_token()}}',
                            id : id,
