            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                ...
                <div class="card">
                    ...
                    <div class="card-body">    
                        <div class="row mb-2">
                            <div class="col-md-12">
                                <form class="form-inline" action="{{ url('/admin/validator/laporan/pekerjaan-terlambat-submit/search') }}" method="get" autocomplete="off">
                                    <div class="row">
                                    ...
                                    @if($rs_terlambat_submit->count() > 0)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{ url('/admin/validator/laporan/pekerjaan-terlambat-submit/detail') }}/{{$terlambat_submit->id}}/{{$key}}/{{$year}}">
