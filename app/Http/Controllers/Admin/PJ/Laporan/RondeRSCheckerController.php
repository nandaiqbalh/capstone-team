...
use App\Models\Admin\Checker\Laporan\RondeRSModel;
use Illuminate\Support\Str;
use Barryvdh\DomPDF\Facade\Pdf as PDF;
use App\Helpers\DateIndonesia as dtid;

class RondeRSCheckerController extends BaseController
{
    ...
    public function index()
    {
        ...
        // view
        return view('admin.checker.laporan.ronde-rs.index', $data );
    }
    ...
    public function search(Request $request)
    {
        ...
        if($request->action == 'search') {
            ...
            $rs_laporan_ronde = RondeRSModel::getAllSearch($region_name, $branch_id, $month, $year);
    ...
    public function executiveReportView($id)
    {
        ...
        if(!empty($laporan_ronde)) {
            ...
            //view
            return view('admin.checker.laporan.ronde-rs.executive-report-view', $data);
        }
        else {
            // flash message
