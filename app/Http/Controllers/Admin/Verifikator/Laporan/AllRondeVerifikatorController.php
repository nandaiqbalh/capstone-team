...
class AllRondeVerifikatorController extends BaseController
{
    ...
    public function index()
    {
        ...
        // view
        return view('admin.verifikator.laporan.semua-ronde.index', $data );
    }
    ...
    public function detail($id)
    {
        ...
        if(!empty($laporan_ronde)) {
            ...
            //view
            // dd($rs_assessment);
            return view('admin.verifikator.laporan.semua-ronde.detail', $data);
        }
        else {
    ...
    public function executiveReportDownload($id)
    {
        ...
        if(!empty($laporan_ronde)) {
            ...
            //view
            $pdf = PDF::loadview('admin.verifikator.laporan.semua-ronde.executive-report-pdf', $data);
