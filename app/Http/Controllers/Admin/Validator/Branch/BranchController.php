...
use App\Models\Admin\Validator\Branch\BranchModel;
...
class BranchController extends BaseController
{
    ...
    public function index()
    {
        ...
        // view
        return view('admin.validator.branch.branch.index', $data );
    }
    ...
    public function search(Request $request)
    {
        ...
        if($request->action == 'search') {
            ...
            return redirect('/admin/validator/rumah-sakit');
        }
    }
    ...
    public function add()
    {
        ...
        //view
        return view('admin.validator.branch.branch.add', $data);
    }
    ...
    public function addProcess(Request $request)
    {
        ...
        if (BranchModel::insert($params)) {
            ...
            $params =[
                'round_id' => BranchModel::getDataRound(date("d"))->id,
                'branch_id' => $branch_id,
                'direg_name'=> BranchModel::getDiregNameByRegionalName($request->region_name),
                'status' => 'proses penilaian',
                'created_by'   => Auth::user()->user_id,
                'created_date'  => date('Y-m-d H:i:s')
            ];
            BranchModel::insertBranchAssessment($params);
            // flash message
            session()->flash('success', 'Data berhasil disimpan.');
            return redirect('/admin/validator/rumah-sakit/add');
        }
        else {
            // flash message
    ...
    public function edit($id)
    {
        ...
        if(!empty($branch)) {
            ...
            //view
            return view('admin.validator.branch.branch.edit', $data);
        }
        else {
            // flash message
    ...
    public function detail($id)
    {
        ...
        if(!empty($branch)) {
            ...
            //view
            return view('admin.validator.branch.branch.detail', $data);
        }
        else {
            // flash message
            session()->flash('danger', 'Data tidak ditemukan.');
    ...
    public function addAkun($id)
    {
        ...
        if(!empty($branch)) {
            ...
            if(count($user_checker) == 0){
                ...
                //view
                return view('admin.validator.branch.branch.add-akun', $data);
            }
            else {
                // flash message
    ...
    public function editAkun($id)
    {
        ...
        if(!empty($user)) {
            ...
            //view
            return view('admin.validator.branch.branch.edit-akun', $data);
        }
        else {
            // flash message
            session()->flash('danger', 'Data tidak ditemukan.');
    ...
    public function editAkunProcess(Request $request)
    {
        ...
        if (BranchModel::update_app_user($request->user_id, $params)) {
            ...
            return redirect('/admin/validator/rumah-sakit/akun/edit'.'/'.$request->user_id);
