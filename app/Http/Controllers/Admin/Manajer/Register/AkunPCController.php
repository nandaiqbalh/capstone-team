...
use App\Models\Admin\Manajer\Register\AkunPCModel;
...
class AkunPCController extends BaseController
{
    ...
    public function index()
    {
        ...
        // view
        return view('admin.checker.register.akun-rs.index', $data );
    }
    ...
    public function add()
    {
        ...
        // view
        return view('admin.checker.register.akun-rs.add');
    }
    ...
    public function addProcess(Request $request)
    {
        ...
        $rules = [
            ...
            'role_id' => 'required',
            'nik' => 'required|digits_between:6,15|numeric',
        ];
        $this->validate($request, $rules );

        // cek email
        $role_check = AkunPCModel::getByRole($request->role_id);
        if(!empty($role_check)) {
             // flash message
             session()->flash('danger', 'Jabatan sudah terdaftar.');
             return redirect('/admin/checker/register/akun-rs/add')->withInput();
        }
        $pass = Str::random(8);
        // params
        ...
        if(parent::sendMail($data)) {
            ...
            return redirect('/admin/checker/register/akun-rs/');
        }
    ...
    public function detail($id)
    {
        ...
        // view
        return view('admin.checker.register.akun-rs.detail', $data );
    }
    ...
    public function edit($id)
    {
        ...
        // view
        return view('admin.checker.register.akun-rs.edit', $data );
    }
    ...
    public function editProcess(Request $request)
    {
        ...
        if (AkunPCModel::update($request->user_id, $params)) {
            ...
            // flash message
            session()->flash('danger', 'Data gagal disimpan.');
            return redirect('/admin/checker/register/akun-rs/edit/'.$request->user_id);
        }
    }
