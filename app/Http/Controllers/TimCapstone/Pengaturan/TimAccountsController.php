...
namespace App\Http\Controllers\TimCapstone\Pengaturan;

use App\Http\Controllers\TimCapstone\BaseController;
use App\Models\TimCapstone\Pengaturan\Accounts;
...
class TimAccountsController extends BaseController
{
    ...
    public function index()
    {
        ...
        // return
        return view('tim_capstone.pengaturan.accounts.index', $data);
    }
    ...
    public function search(Request $request)
    {
        ...
        if ($request->action == 'search') {
            ...
            return redirect('/tim-capstone/pengaturan/accounts');
        }
    }
    ...
    public function import(Request $request)
    {
        try {
            ...
            if ($validator->fails()) {
                ...
                return redirect('/tim-capstone/pengaturan/accounts/add');
            }
            ...
            if ($import) {
                if (!empty($failedRows)) {
                    return redirect('/tim-capstone/pengaturan/accounts')->withInput()->with('failedRows', $failedRows);
                ...
                return redirect('/tim-capstone/pengaturan/accounts/add')->withInput()->with('failedRows', $failedRows);
            }
    ...
    public function add()
    {
        ...
        // return
        return view('tim_capstone.pengaturan.accounts.add', $data);
    }
    ...
    public function addProcess(Request $request)
    {
        ...
        if (in_array($request->role_id, ['02', '04']) && $request->filled('angkatan')) {
            ...
            return redirect('/tim-capstone/pengaturan/accounts/add')->withInput();
        }
    ...
    public function edit($id)
    {
        ...
        if (!empty($account)) {
            //view
            return view('tim_capstone.pengaturan.accounts.edit', $data);
        } else {
            // flash message
    ...
    public function editProcess(Request $request)
    {
        ...
        if (in_array($request->role_id, ['02', '04']) && $request->filled('angkatan')) {
            // Flash message
            session()->flash('danger', 'Role tersebut tidak boleh memiliki angkatan.');
            return redirect('/tim-capstone/pengaturan/accounts/edit/' . $request->user_id)->withInput();
        }
        ...
        if (Accounts::update($request->user_id, $params)) {
            ...
            // Flash message
            session()->flash('danger', 'Data gagal disimpan.');
            return redirect('/tim-capstone/pengaturan/accounts/edit/' . $request->user_id);
        }
    }
    ...
    public function editPassword($id)
    {
        ...
        if (!empty($account)) {
            //view
            return view('tim_capstone.pengaturan.accounts.edit-password', $data);
        } else {
            // flash message
            session()->flash('danger', 'Data tidak ditemukan.');
            return redirect('/tim-capstone/pengaturan/accounts');
    ...
    public function editPasswordProcess(Request $request)
    {
        ...
        if ($request->new_password != $request->repeat_new_password) {
            ...
            return redirect('/tim-capstone/pengaturan/accounts/edit_password/' . $request->user_id)->withInput();
        }
