    ...
    public function import(Request $request)
    {
        try {
            ...
            if ($validator->fails()) {
                ...
                return redirect('/tim-capstone/mahasiswa/add');
            }
            ...
            if ($import) {
                if (!empty($failedRows)) {
                    return redirect('/tim-capstone/mahasiswa')->withInput()->with('failedRows', $failedRows);
            ...
            return redirect('/tim-capstone/mahasiswa/add')->withInput()->with('failedRows', $failedRows);
        }
    }
