...
class ApiBaseModel
{
     ...
     * @type is C,R,U,D
     */
    public static function authorize($type, $user_id) {
        ...
        if (!empty($permission)) {
            if ($type == 'C') {
                return substr($permission->role_permission, 0, 1) == '1';
            } elseif ($type == 'R') {
                return substr($permission->role_permission, 1, 1) == '1';
            } elseif ($type == 'U') {
                return substr($permission->role_permission, 2, 1) == '1';
            } elseif ($type == 'D') {
                return substr($permission->role_permission, 3, 1) == '1';
            } else {
                return false;
            }
        } else {
