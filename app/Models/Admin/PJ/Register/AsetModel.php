...
class AsetModel extends BaseModel
{
    ...
    public static function getDataAllSubArea() {
        return DB::table('branch_items as a')
            ...
            ->leftJoin('master_branch as b', 'a.branch_id','b.id')
            ->leftJoin('master_items as c', 'a.items_id','c.id')
            ->leftJoin('master_sub_area as d', 'a.sub_area_id','d.id')
            ->leftJoin('master_area as e', 'd.area_id','e.id')
            ->leftJoin('master_location as f', 'e.location_id','f.id')
    ...
    public static function getDataRoundBranch($start_day,$month,$year,$branch_id) {
        return DB::table('branch_assessment as a')
            ...
            ->leftJoin('master_round as b','a.round_id','b.id')
            ->leftJoin('master_branch as c','a.branch_id','c.id')
    ...
    public static function getKomponen($branch_id,$round_id,$items_id) {
        return DB::table('branch_items as a')
            ...
            ->leftJoin('master_sub_area as b','a.sub_area_id','=','b.id')
            ->leftJoin('master_area as c','b.area_id','=','c.id')
            ->leftJoin('master_items as d','a.items_id','=','d.id')
            ->leftJoin('master_assessment_component as e','e.items_id','=','d.id')
            ->where('a.branch_id', $branch_id)
    ...
    public static function getByRole($role) {
        return DB::table('app_user as a')
            ...
            ->leftJoin('app_role_user as b', 'a.user_id','b.user_id')
            ->leftJoin('app_role as c', 'b.role_id','c.role_id')
            ->where('a.branch_id', Auth::user()->branch_id)
    ...
    public static function getDataAssessment($round_id) {
        return DB::table('branch_assessment_detail as a')
            ...
            ->leftJoin('branch_assessment as b','a.branch_assessment_id','b.id')
            ->leftJoin('branch_items as c','a.branch_items_id','c.id')
            ->leftJoin('master_items as d', 'c.items_id','d.id')
            ->leftJoin('master_sub_area as e', 'c.sub_area_id','e.id')
            ->leftJoin('master_area as f', 'e.area_id','f.id')
            ->leftJoin('master_location as g', 'f.location_id','g.id')
            ->leftJoin('master_assessment_component as h', 'a.assessment_component_id','h.id')
